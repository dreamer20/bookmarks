...
INSERT INTO bookmarks (url, title, icon_url, owner_id) VALUES ('https://test.com', 'Some title', 'https://test.com/favicon.ico', 2);
INSERT INTO bookmarks (url, title, icon_url, owner_id) VALUES ('https://test2.com', 'Some title', 'https://test2.com/favicon.ico', 2);
INSERT INTO bookmarks (url, title, icon_url, owner_id) VALUES ('https://test3.com', 'Some title', 'https://test3.com/favicon.ico', 2);